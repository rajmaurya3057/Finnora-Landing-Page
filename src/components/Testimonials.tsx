...
const testimonials = [
  {
    ...
    role: "Freelancer",
    quote:
      "Fiinora helped me visualize my monthly income and expenses clearly. It feels like having a personal finance coach.",
  ...
  },
  {
    ...
    role: "Investor",
    quote:
      "I love how clean and interactive the dashboard is. It's not just data — it feels alive.",
  ...
  },
  {
    ...
    role: "Student",
    quote:
      "Managing expenses was stressful. Finnora made it simple and actually enjoyable.",
