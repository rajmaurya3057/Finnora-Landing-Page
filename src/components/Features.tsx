...
const features = [
  {
    ...
    description:
      "Automatically categorize your transactions, visualize spending trends, and set monthly budgets effortlessly.",
  ...
  },
  {
    ...
    description:
      "Track your stocks, mutual funds, and crypto with live data and AI-powered growth insights.",
  ...
  },
  {
    ...
    description:
      "Manage policies, EMIs, and loans in one secure place with timely reminders.",
  ...
  },
  {
    ...
    description:
      "AI-driven recommendations to save more, invest better, and plan smarter.",
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Fiinora brings together your expenses, investments, insurance, and
            insights in one simple dashboard.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div
                className="absolute inset-0 bg-gradient-to-r opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-xl rounded-2xl"
                style={{
